...
//		setVisible(true);
        ...
        setTitle("Welcome to ConnectiFy");
        ...
        // Use a JLayeredPane to manage component layering
        ...
        ImageIcon backgroundImage = new ImageIcon(getClass().getResource("/images/aaaaaaC O N N E C T I F Y (2).png"));
        ...
        lblNewLabel.setBounds(276, 46, 148, 83);

        layeredPane.add(lblNewLabel, JLayeredPane.PALETTE_LAYER);
        ...
        layeredPane.add(useridtxt, JLayeredPane.PALETTE_LAYER);
        ...
        layeredPane.add(useridlbl, JLayeredPane.PALETTE_LAYER);
        ...
        layeredPane.add(pwdlbl, JLayeredPane.PALETTE_LAYER);
        ...
        layeredPane.add(loginbt, JLayeredPane.PALETTE_LAYER);
        ...
        layeredPane.add(registerbt, JLayeredPane.PALETTE_LAYER);
